        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenderOrientation = table.Column<int>(type: "int", nullable: false),
                    BrandId = table.Column<int>(type: "int", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    SizesQuantities = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUsersClothes", x => new { x.ApplicationUserId, x.ClothId });
                    table.ForeignKey(
                        name: "FK_ApplicationUsersClothes_Clothes_ClothId",
                        column: x => x.ClothId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsersClothes_ClothId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ApplicationUsersClothes_AspNetUsers_ApplicationUserId",
                table: "ApplicationUsersClothes",
                column: "ApplicationUserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
